...
export function CookieResults({ results, onResetAction }: CookieResultsProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="border-4 border-blue-300 bg-gradient-to-r from-blue-50 to-yellow-50 shadow-lg">
        <CardContent className="p-6">
          <div className="text-center">
            <div className="text-4xl mb-4">🍪👾</div>
            <div className="text-xl font-comic-sans text-blue-800 mb-4">
              Cookie Monster's Security Report
            </div>
            <div className="text-lg font-bold text-blue-700 bg-white rounded-lg p-4 border-2 border-blue-200 shadow-sm">
              "{monsterMessage}"
            </div>
          </div>
        </CardContent>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card className="border-2 border-blue-200">
          <CardContent className="p-4 text-center">
            <div className="text-2xl font-bold text-blue-600">{results.cookies.length}</div>
        ...
        <Card className="border-2 border-red-200">
          <CardContent className="p-4 text-center">
            <div className="text-2xl font-bold text-red-600">{results.trackers.length}</div>
            <div className="text-sm text-gray-600">Tracker Cookies</div>
          </CardContent>
        </Card>
        
        <Card className="border-2 border-orange-200">
          <CardContent className="p-4 text-center">
            <div className="text-2xl font-bold text-orange-600">{results.thirdPartyCookies.length}</div>
        ...
        <Card className="border-2 border-purple-200">
          <CardContent className="p-4 text-center">
            <div className="text-2xl font-bold text-purple-600">{results.vulnerabilities.length}</div>
        ...
        <Card className="border-2 border-blue-200 shadow-md">
          ...
          <CardContent className="pt-4">
            <div className="flex items-center justify-between">
              <div>
                <div className={`text-4xl font-bold ${getScoreColor(results.privacyScore)}`}>
              ...
              <Badge variant="outline" className={getScoreBadgeColor(results.privacyScore)}>
        ...
        <Card className="border-2 border-green-200 shadow-md">
          ...
          <CardContent className="pt-4">
            <div className="flex items-center justify-between">
              ...
              <Badge variant="outline" className={getScoreBadgeColor(results.securityScore)}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-medium">Fingerprinting Risk</span>
                <Badge className={getSeverityColor(results.fingerprinting.fingerprintingRisk)}>
                  {results.fingerprinting.fingerprintingRisk.toUpperCase()}
                </Badge>
              </div>
              <div className="flex items-center justify-between text-sm">
                <span>Screen Resolution</span>
                <span className="font-mono">{results.fingerprinting.screenResolution}</span>
              </div>
              <div className="flex items-center justify-between text-sm">
                <span>Timezone</span>
                <span className="font-mono">{results.fingerprinting.timezone}</span>
              </div>
              <div className="flex items-center justify-between text-sm">
                <span>Language</span>
                <span className="font-mono">{results.fingerprinting.language}</span>
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center justify-between text-sm">
                <span>Platform</span>
                <span className="font-mono">{results.fingerprinting.platform}</span>
              </div>
              <div className="flex items-center justify-between text-sm">
              ...
              {'hardwareConcurrency' in results.fingerprinting && (
                <div className="flex items-center justify-between text-sm">
                  <span>CPU Cores</span>
                  <span className="font-mono">{results.fingerprinting.hardwareConcurrency}</span>
                </div>
              )}
            </div>
          </div>
        ...
        <CardContent className="pt-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
            <div className="text-center p-3 bg-blue-50 rounded-lg">
              <div className="text-2xl font-bold text-blue-600">{results.sessionSecurity.sessionCookieCount}</div>
              <div className="text-sm text-gray-600">Session Cookies</div>
            ...
            <div className="text-center p-3 bg-purple-50 rounded-lg">
              <div className="text-2xl font-bold text-purple-600">{results.sessionSecurity.persistentCookieCount}</div>
              <div className="text-sm text-gray-600">Persistent Cookies</div>
            ...
            <div className="text-center p-3 bg-green-50 rounded-lg">
              ...
              <div className="text-sm text-gray-600">Secure Cookies</div>
            ...
            <div className="text-center p-3 bg-orange-50 rounded-lg">
              ...
              <div className="text-sm text-gray-600">HttpOnly Cookies</div>
          ...
          <div className="bg-gray-50 rounded-lg p-4 border mb-4">
            <div className="flex items-center justify-between mb-3">
              <span className="font-semibold text-gray-800">Overall Session Security Rating</span>
              <Badge className={
                ...
                <div key={index} className="bg-white rounded-lg p-4 border border-red-200 shadow-sm">
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-2 flex-1">
                      ...
                      <span className="font-semibold text-gray-900">{vuln.description}</span>
                    </div>
              ...
              {results.cookies.map((cookie, index) => (
                <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-200">
                  <div className="flex items-center gap-3 flex-1 min-w-0">
                    <div className="font-mono text-sm bg-white px-2 py-1 rounded border truncate flex-1">
                      {cookie.name}
                    </div>
            ...
            <div className="space-y-3">
              {results.recommendations.map((rec, index) => (
                <div key={index} className="bg-white rounded-lg p-4 border border-blue-200">
                  ...
                  <p className="text-sm font-medium text-green-700 mb-2">✅ {rec.action}</p>
